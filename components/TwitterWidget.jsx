...
function TwitterWidget() {
  ...
  return (
    <div className="max-w-6xl mx-auto p-6 justify-center rounded-xl mb-16">
     <h1 className="text-lg md:text-3xl relative left-1/2 -translate-x-1/2 font-bold bg-yellow-200 px-4 py-2 inline-block rounded-md mb-8 md:mt-16 md:mb-32">
    ...
    />
      ...
      <div className="flex flex-row flex-wrap justify-evenly gap-8 w-full">
        <div className="rounded-lg shadow-md transition-all bg-white hover:shadow-lg">
          <iframe
