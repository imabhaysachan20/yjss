export default function AboutUs() {
  return (
    <div className="flex border rounded flex-col md:flex-row items-center justify-center min-h-screen px-8 py-36">
      {/* Left Side - Image */}
      ...
      {/* Right Side - Content */}
      <div className="w-full md:w-1/2 p-6 relative bg-white shadow-lg rounded-xl">
        {/* Decorative Quotation Mark (Top-Left) */}
        <span className="absolute -top-5 -left-2 text-[6rem] text-gray-300 font-serif -translate-x-3 -translate-y-4 select-none">
          “
        </span>
