    ...
    <div className="mb-24">
      ...
      <div className="flex justify-between items-center">
        ...
        >
          ...
          <Input
            placeholder={t("support.phoneNumber")}
            value={phone}
          ...
          <Select onValueChange={handleDistrictChange}>
            <SelectTrigger className="mb-3 w-full">
              <SelectValue placeholder={t("support.District")} />
            </SelectTrigger>
            <SelectContent>
          ...
          {selectedDistrict && (
            <Select onValueChange={setSelectedLoksabha}>
              <SelectTrigger className="mb-3 w-full">
                <SelectValue placeholder={t("support.SLS")} />
              </SelectTrigger>
              <SelectContent>
          ...
          {errors.loksabha && (
            <p className="text-red-500 text-sm">{errors.loksabha}</p>
          )}

          {selectedLoksabha &&
            districts[selectedDistrict]?.vidansabha?.[selectedLoksabha] && (
              <Select onValueChange={setSelectedVidansabha}>
                <SelectTrigger className="mb-3 w-full">
                  <SelectValue placeholder={t("support.SVS")} />
                </SelectTrigger>
                <SelectContent>
                  {districts[selectedDistrict]?.vidansabha?.[
                    selectedLoksabha
                  ]?.map((vs) => (
          ...
          {errors.vidansabha && (
            <p className="text-red-500 text-sm">{errors.vidansabha}</p>
          )}
          ...
          {selectedDistrict && selectedVidansabha != "कल्याणपुर" && (
            <div className="mb-4">
              ...
              {errors.areaType && (
                <p className="text-red-500 text-sm">{errors.areaType}</p>
              )}
            </div>
          )}
            ...
            <>
              ...
              {selectedBlock && (
                <Select onValueChange={setSelectedGramPanchayat}>
                  ...
                  <SelectContent>
                    {districts[selectedDistrict].grampanchayat[
                      selectedBlock
                    ].map((gp) => (
              ...
              {errors.gramPanchayat && (
                <p className="text-red-500 text-sm">{errors.gramPanchayat}</p>
              )}
            </>
          )}
          ...
          {submitStatus === "success" && (
            <div className="mb-4 p-3 bg-green-100 text-green-700 rounded-md">
              आपकी समस्या सफलतापूर्वक जमा कर दी गई है। हम जल्द ही आपसे संपर्क
              करेंगे।
            </div>
          )}
